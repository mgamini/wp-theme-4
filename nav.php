    <nav id="filters" class="clearfix" data-option-key="filter">
      <ul id="topFilters">
      	<li id="navPortfolio"><a href="<?php bloginfo( url ); ?>/#filter=%3Anot(.category-cat-blog)" <?php if (in_category( array('cat-ui','cat-ux','cat-web','cat-print','cat-identity' ) )) { echo "class='selected'" ; } ?> >Portfolio</a></li>
      ...
      <ul id="portfolioFilters">
        <li><a href="<?php bloginfo( url ); ?>/#filter=%3Anot(.category-cat-blog)">all</a></li>
